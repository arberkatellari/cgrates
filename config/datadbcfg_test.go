...
func TestDataDbCfgAsMapInterface(t *testing.T) {
	...
	eMap := map[string]any{
		...
		utils.ItemsCfg: map[string]any{
			utils.MetaAccounts:            map[string]any{utils.RemoteCfg: true, utils.ReplicateCfg: false, utils.APIKeyCfg: "randomVal", utils.RouteIDCfg: "randomVal", utils.LimitCfg: -1, utils.StaticTTLCfg: false, utils.TTLCfg: "1ns", utils.CloneCfg: false},
			utils.MetaReverseDestinations: map[string]any{utils.RemoteCfg: false, utils.ReplicateCfg: false, utils.APIKeyCfg: "randomVal", utils.RouteIDCfg: "randomVal", utils.LimitCfg: -1, utils.StaticTTLCfg: false, utils.TTLCfg: "1ns", utils.CloneCfg: false},
		},
	}
