...
func (m *Migrator) migrateCurrentRequestFilter() (err error) {
	dataDB, _, err := m.dmIN.DataManager().DBConns().GetConnID(utils.MetaFilters)
	if err != nil {
		return err
	}
	var ids []string
...
func (m *Migrator) migrateResourceProfileFiltersV1() (err error) {
	dataDB, _, err := m.dmIN.DataManager().DBConns().GetConnID(utils.MetaResourceProfiles)
	if err != nil {
		return err
	}
	var ids []string
...
func (m *Migrator) migrateStatQueueProfileFiltersV1() (err error) {
	dataDB, _, err := m.dmIN.DataManager().DBConns().GetConnID(utils.MetaStatQueueProfiles)
	if err != nil {
		return err
	}
	var ids []string
...
func (m *Migrator) migrateThresholdsProfileFiltersV1() (err error) {
	dataDB, _, err := m.dmIN.DataManager().DBConns().GetConnID(utils.MetaThresholdProfiles)
	if err != nil {
		return err
	}
	var ids []string
...
func (m *Migrator) migrateAttributeProfileFiltersV1() (err error) {
	dataDB, _, err := m.dmIN.DataManager().DBConns().GetConnID(utils.MetaAttributeProfiles)
	if err != nil {
		return err
	}
	var ids []string
...
func (m *Migrator) migrateChargerProfileFiltersV1() (err error) {
	dataDB, _, err := m.dmIN.DataManager().DBConns().GetConnID(utils.MetaChargerProfiles)
	if err != nil {
		return err
	}
	var ids []string
...
func (m *Migrator) setFilterv5WithoutCompile(fltr *engine.Filter) (err error) {
	dataDB, _, err := m.dmOut.DataManager().DBConns().GetConnID(utils.MetaFilters)
	if err != nil {
		return err
	}
