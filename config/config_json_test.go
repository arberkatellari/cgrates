	...
	eCfg := &CacheJsonCfg{
		Partitions: &map[string]*CacheParamJsonCfg{
			utils.CacheDestinations: {Limit: utils.IntPointer(-1),
				...
				Precache: utils.BoolPointer(false), Remote: utils.BoolPointer(false), Replicate: utils.BoolPointer(false), Clone_items: utils.BoolPointer(false)},
			...
			utils.CacheEventResources: {Limit: utils.IntPointer(-1),
				Ttl: utils.StringPointer(""), Static_ttl: utils.BoolPointer(false),
				Remote: utils.BoolPointer(false), Replicate: utils.BoolPointer(false), Clone_items: utils.BoolPointer(false)},
			...
			utils.CacheCapsEvents: {Limit: utils.IntPointer(-1),
				...
				Clone_items: utils.BoolPointer(false)},
...
func TestDfDataDbJsonCfg(t *testing.T) {
	eCfg := &DbJsonCfg{
		...
		Opts: &DBOptsJson{
			...
			InternalDBWriteLimit:      utils.IntPointer(-1),
