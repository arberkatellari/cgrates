...
func (dm *DataManager) SetTiming(t *utils.TPTiming) (err error) {
	...
	if t.StartTime != utils.EmptyString && t.StartTime != utils.MetaASAP && !utils.IsTimeFormated(t.StartTime) && !strings.HasPrefix(t.StartTime, utils.PlusChar) &&
		!strings.HasPrefix(t.StartTime, utils.MinusChar) {
